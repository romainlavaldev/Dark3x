...
public class FichierC extends Fichier {
    public FichierC(Projet projet, File fichier) {
        super(projet, fichier);
        this.setSyntaxStyle("text/c");
        this.setCommentaire("//");
    }

    public FichierC(Projet projet, String nom, boolean vide) {
        super(projet, nom);
        this.setSyntaxStyle("text/c");
        this.setCommentaire("//");
        if (!vide) {
    ...
    public FichierC(Projet projet, String nom, String contenu) {
